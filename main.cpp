...
public:
  ...
  void ParseCommandLine(int argc, char **argv) {
    static const char *help = "Logicoin-seeder\n"
...
static const string mainnet_seeds[] = {"logic.l337bet.net", ""};
static const string testnet_seeds[] = {"testnet-logic.l337bet.net", ""};
static const string *seeds = mainnet_seeds;

extern "C" void* ThreadSeeder(void*) {
  if (!fTestNet){
    db.Add(CService("kjy2eqzk4zwi5zd3.onion", 9653), true);
  }
  do {
